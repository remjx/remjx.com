...
Interaction fees have gotten lower as the userbase has increased, but as it stands today:
...
My humble opinion is that Twitter users should not expect to ditch the platform anytime soon. The community is much larger and diverse on Twitter and I don't think that will change anytime soon. There are some people that don't want to pay to post, and circumstances where you don't want a post to exist immutably on the blockchain.
...
If Twetch sounds interesting to you, hang out on Twetch for a bit and see if you like the community. Try to earn some money from your followers. Get indoctrinated by the memes.
...
Feel free to reach out to me on <a href={links.myTwitter}>Twitter</a> or <a href={links.myTwetchUrl}>Twetch</a> for any comments, questions, corrections, etc.

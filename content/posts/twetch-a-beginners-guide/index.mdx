...
The existence of these different forks (versions) of Bitcoin was essentially the result of digital civil wars between factions of bitcoin users who disagreed on what the protocol rules should be.

> My opinion: all forks of Bitcoin are Bitcoin and it is wise to keep ownership parity across all Bitcoin forks (BTC, BCH, BSV). Nobody knows for sure which will succeed or fail. It is possible they all succeed, gaining adoption & value over time, but being used for different purposes by different groups of people. I see BTC as digital gold, BCH as digital cash with a focus on retail adoption, and BSV as digital cash with a focus on digital enterprises with on-chain data.
